<!-- AUTO-GENERATED: run python tools/update_pipeline.py -->\n\n# zohosign__ZohoSign_Document_Events Module - Status Map
...
|-----|--------------|-------------|------|-----|
| 1 | Available | null | used | 52330000002595510 |
| 2 | Draft | null | used | 52330000002595512 |
| 3 | Trash | null | used | 52330000002595514 |
