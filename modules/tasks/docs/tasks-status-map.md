...
|-----|--------------|-------------|------|-----|
| 1 | Not Started | null | used | 52330000000013483 |
| 2 | Deferred | null | used | 52330000000013486 |
| 3 | In Progress | null | used | 52330000000013489 |
| 4 | Completed | null | used | 52330000000013492 |
| 5 | Waiting for input | null | used | 52330000000013495 |
...
| Seq | Display Value | Colour Code | Type | ID |
|-----|--------------|-------------|------|-----|
| 1 | Trash | null | used | 52330000002021114 |
| 2 | Available | null | used | 52330000002021115 |
| 3 | Draft | null | used | 52330000002021116 |
