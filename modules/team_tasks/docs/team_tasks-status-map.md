...
|-----|--------------|-------------|------|-----|
| 1 | Available | null | used | 52330000002487181 |
| 2 | Draft | null | used | 52330000002487183 |
| 3 | Trash | null | used | 52330000002487185 |
...
| Seq | Display Value | Colour Code | Type | ID |
|-----|--------------|-------------|------|-----|
| 1 | -None- | null | used | 52330000002498396 |
| 2 | Not Started | null | used | 52330000002498391 |
| 3 | In Progress | null | used | 52330000006161595 |
| 4 | Completed | null | used | 52330000002498393 |
| 5 | Cancelled | null | used | 52330000004065288 |
