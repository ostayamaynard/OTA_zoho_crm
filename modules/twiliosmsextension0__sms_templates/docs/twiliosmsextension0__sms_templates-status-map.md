<!-- AUTO-GENERATED: run python tools/update_pipeline.py -->\n\n# twiliosmsextension0__SMS_Templates Module - Status Map
...
|-----|--------------|-------------|------|-----|
| 1 | Available | null | used | 52330000013910073 |
| 2 | Draft | null | used | 52330000013910075 |
| 3 | Trash | null | used | 52330000013910077 |
