<!-- AUTO-GENERATED: run python tools/update_pipeline.py -->\n\n# twiliosmsextension0__Inbound_SMS Module - Status Map
...
|-----|--------------|-------------|------|-----|
| 1 | Available | null | used | 52330000013912599 |
| 2 | Draft | null | used | 52330000013912601 |
| 3 | Trash | null | used | 52330000013912603 |
